...
export const numberLevel = document.querySelector('.level');
export const bg = document.querySelector('.bg');
export const winLevel3 = document.querySelector('.win');

export const scoreWin = document.querySelector('#scoreWin');
